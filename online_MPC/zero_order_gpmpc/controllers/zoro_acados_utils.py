...
def transform_ocp(ocp_input):
    ...
    model_lin.name = ocp.model.name
    model_lin.con_h_expr = ocp.model.con_h_expr
    model_lin.con_h_expr_0 = ocp.model.con_h_expr_0
    model_lin.con_h_expr_e = ocp.model.con_h_expr_e
    model_lin.cost_expr_ext_cost = ocp.model.cost_expr_ext_cost
    model_lin.cost_expr_ext_cost_0 = ocp.model.cost_expr_ext_cost
    ...
    # ocp.solver_options.nlp_solver_max_iter = 100 # Default is 100, otherwise defined in ocp_input
    return ocp
